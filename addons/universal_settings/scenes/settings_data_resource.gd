...
# "Fullscreen"       : DisplayServer.WINDOW_MODE_EXCLUSIVE_FULLSCREEN 	> index=0, value=4
# "Window"           : DisplayServer.WINDOW_MODE_WINDOWED				> index=1, value=0
# "Window Maximized" : DisplayServer.WINDOW_MODE_MAXIMIZED				> index=2, value=2

# The following is the default window mode. This will override any project settings.
@export var window_mode : int = 0		# use value
@export var window_mode_index : int = 1 # use index
...
@export var resolution_index : int = 1 # use index in the resolutions dictionary
